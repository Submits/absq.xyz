    ...
    client.query(
      ...
      .then(function(ret) {    
        ...
        let userinfo = users.findIndex(function(item, i) {
          ...
          document.getElementById("info").innerHTML = `Uploaded by <a style="color:` + users[userinfo].user_colour + `" href="profile.html?id=` + users[userinfo].id  + `"><b>` + users[userinfo].username + `</b></a> on <b>` + ret.data.timestamp + "</b><br>Device: <b>" + ret.data.device + "</b>"
